...
export const siteConfig: SiteConfig = {
	title: "mio's blog",
	subtitle: "",
	siteURL: "https://mio.blue/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2025-11-17", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/mio-qwq",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/457105868",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "email",
					url: "mailto:mioqwq@outlook.com",
					external: true,
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://db.mio.blue/.netlify/functions/twikoo",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到mio的blog~ blog仍在建设中。。敬请期待哦~", // 公告内容
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		home: "點這裡可以回家喔～(´･ω･`)",
		skin: ["想看看我的新衣服嗎？o(*￣▽￣*)ブ", "換裝完畢！讚不讚！"],
		close: "記得回來看我哦...(｡•́︿•̀｡)",
		link: "https://github.com/mio-qwq ",
	},
};
...
export const umamiConfig = {
	...
	apiKey: import.meta.env.UMAMI_API_KEY || "api_LT0PltvLK2sIKHzAVrUs6moicsP58ooD", // API密钥优先从环境变量读取，否则使用配置文件中的值
	baseUrl: "https://api.umami.is", // Umami Cloud API地址
	scripts: `
<script defer src="https://cloud.umami.is/script.js" data-website-id="7bf355a5-2563-4bde-ace8-ee056d276531"></script>
